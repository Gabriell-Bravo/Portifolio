<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      <p class="text-amber-200">Hello World, eu sou o</p>
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Gabriel Bravo</h1>
      <div class="py-2">
        <h1
      ...
      <p class="text-white pr-4 fade-in-from-left">Bem Vindo ao meu Portifolio. <span class="wave">👋🏼</span></p>
      <br>
      <!-- <button
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img class="md:h-auto rounded-full border-4 border-amber-200 pict" alt="avatar" 
      fetchpriority="high" width="300" height="300" decoding="async" data-ning="1" src="/img/eu.jpg">
    </div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Web Developer", "Full-stack Engineer", "Software Engineer Student", "Tech Enthusiast"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
