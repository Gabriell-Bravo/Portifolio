  ...
  data() {
    return {
      ...
      items: [
        ...
        {
          id: 2,
          name: 'Sistema_Protocolo',
          imageUrl: 'Sistema_Protocolo',
          status: 'Sistema de monitoramento de processos da prefeitura de Saquarema',
          tech: 'Django, Java Script, python, postgree, HTML, CSS ',
          github: 'https://github.com/Gabriell-Bravo/Sistema_Protocolo-CGM',
          demo: ''
        },
//         {
//           id: 3,
